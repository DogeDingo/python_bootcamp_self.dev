# 3. Given is a list called community_members with names of our members (strings) in it. All members which have at least the letter "a" 1x in
# should be filtered and stored in a new list variable. Please return the total number of entries of that list. Please copy the list down below in the example for your  community_members.
